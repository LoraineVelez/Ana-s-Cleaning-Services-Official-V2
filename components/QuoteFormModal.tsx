                  ...
                  <section className="space-y-4 md:space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                      <div className="space-y-2">
                        ...
                        <input name="first_name" required type="text" value={formData.firstName} onChange={e => handleInputChange('firstName', e.target.value)} className="w-full bg-gray-50 border-2 border-gray-100 focus:border-[#FF1493] focus:bg-white p-3.5 md:p-4 rounded-xl md:rounded-2xl outline-none transition-all text-gray-900 text-sm md:text-base font-medium placeholder:text-gray-400" placeholder="Jane" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-700 uppercase tracking-wider ml-1">Last Name</label>
                        <input name="last_name" required type="text" value={formData.lastName} onChange={e => handleInputChange('lastName', e.target.value)} className="w-full bg-gray-50 border-2 border-gray-100 focus:border-[#FF1493] focus:bg-white p-3.5 md:p-4 rounded-xl md:rounded-2xl outline-none transition-all text-gray-900 text-sm md:text-base font-medium placeholder:text-gray-400" placeholder="Doe" />
                      </div>
                      <div className="space-y-2">
